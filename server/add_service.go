...
// Add is a pure service and can ignore the context.
func Add(_ context.Context, a, b int) int { return a + b }
...
func AddService(ctx context.Context, req Request) (Response, error) {
