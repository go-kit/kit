...
func TestRetryMaxTotalFail_WCB(t *testing.T) {
    var (
        cb = func(count int, msg string) (bool, *string) { return true, nil }
...
func TestRetryMaxPartialFail_WCB(t *testing.T) {
    var (
        cb = func(count int, msg string) (bool, *string) { return true, nil }
    ...
    if _, err := loadbalancer.RetryWithCallback(retries, time.Second, lb, cb)(ctx, struct{}{}); err == nil {
        t.Errorf("expected error, got none")
    }
}

func TestRetryMaxSuccess_WCB(t *testing.T) {
    var (
        cb = func(count int, msg string) (bool, *string) { return true, nil }
        endpoints = []endpoint.Endpoint{
            func(context.Context, interface{}) (interface{}, error) { return nil, errors.New("error one") },
...
func TestRetryTimeout_WCB(t *testing.T) {
    var (
        cb = func(count int, msg string) (bool, *string) { return true, nil }
        step    = make(chan struct{})
        e       = func(context.Context, interface{}) (interface{}, error) { <-step; return struct{}{}, nil }
        timeout = time.Millisecond
        retry   = loadbalancer.RetryWithCallback(999, timeout, loadbalancer.NewRoundRobin(sd.FixedSubscriber{0: e}), cb)
