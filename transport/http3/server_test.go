...
import (
	...
	httptransport "github.com/go-kit/kit/transport/http3"
)

// nopEndpoint is an endpoint that does nothing and returns a nil error.
// Useful for tests.
func nopEndpoint(context.Context, interface{}) (interface{}, error) { return struct{}{}, nil }
