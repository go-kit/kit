...
See [netrpc_binding.go](https://github.com/openmesh/kit/blob/ec8b02591ee873433565a1ae9d317353412d1d27/examples/addsvc/netrpc_binding.go) for an example.
...
See [addsvc](https://github.com/openmesh/examples/tree/master/addsvc) for a complete working example with net/rpc support.
